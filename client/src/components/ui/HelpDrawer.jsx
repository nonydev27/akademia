...
import {
  Landmark, School, KeyRound, BarChart3, GraduationCap, Users2, NotebookPen,
  Wallet, ClipboardCheck, BookOpen, CheckSquare, Calculator, BookText, X,
} from 'lucide-react';

const HELP_SECTIONS = {
  SUPER_ADMIN: [
    {
      id: 'overview', Icon: Landmark, title: 'Platform Overview',
    ...
    {
      id: 'add-school', Icon: School, title: 'Adding a New School',
    ...
    {
      id: 'subscriptions', Icon: KeyRound, title: 'Managing Subscriptions',
  ...
  SCHOOL_ADMIN: [
    {
      id: 'overview', Icon: BarChart3, title: 'Your Dashboard',
    ...
    {
      id: 'students', Icon: GraduationCap, title: 'Managing Students',
    ...
    {
      id: 'teachers', Icon: Users2, title: 'Adding Teachers & Permissions',
    ...
    {
      id: 'grades', Icon: NotebookPen, title: 'Grade Sheet',
    ...
    {
      id: 'fees', Icon: Wallet, title: 'Fee Management',
    ...
    {
      id: 'results', Icon: ClipboardCheck, title: 'Publishing Results',
    ...
    {
      id: 'subscription', Icon: KeyRound, title: 'Renewing Your Subscription',
  ...
  STAFF: [
    {
      id: 'overview', Icon: BookOpen, title: 'Your Role',
    ...
    {
      id: 'attendance', Icon: CheckSquare, title: 'Marking Attendance',
    ...
    {
      id: 'grades', Icon: NotebookPen, title: 'Entering Grades',
    ...
    {
      id: 'formula', Icon: Calculator, title: 'Grade Formula',
              ...
              <div className="animate-fade-in-up" key={activeSection.id}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-11 h-11 rounded-xl bg-brand-50 flex items-center justify-center flex-shrink-0">
                    <activeSection.Icon className="w-6 h-6 text-brand-600" />
                  </div>
